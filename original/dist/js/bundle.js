...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Quote = function Quote(quote, author, season, episode) {\n  _classCallCheck(this, Quote);\n\n  this.quote = quote, this.author = author, this.season = season, this.episode = episode;\n};\n\nexports.default = Quote;\n\n//# sourceURL=webpack:///./src/js/models/Quote.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.filterQuotes = exports.updateImage = exports.getRandomQuote = exports.renderQuoteDetails = exports.clearQuote = exports.renderQuote = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar renderQuote = exports.renderQuote = function renderQuote(quote) {\n  var markup = '\\n    <p>\\n      ' + quote.quote + '\\n    </p>\\n  ';\n\n  _base.elements.quoteText.insertAdjacentHTML('afterbegin', markup);\n};\n\nvar clearQuote = exports.clearQuote = function clearQuote() {\n  _base.elements.quoteText.innerHTML = '';\n};\n\nvar renderQuoteDetails = exports.renderQuoteDetails = function renderQuoteDetails(quote) {\n  var markup = '\\n     <p>' + quote.author + ': Season ' + quote.season + ', Episode ' + quote.episode + ' </p>\\n  ';\n\n  _base.elements.quoteText.insertAdjacentHTML('beforeend', markup);\n};\n\nvar getRandomQuote = exports.getRandomQuote = function getRandomQuote(quotes) {\n  var index = Math.floor(Math.random() * quotes.length);\n  var quote = quotes[index];\n\n  return quote;\n};\n\nvar updateImage = exports.updateImage = function updateImage(quote) {\n  var character = quote.author.toLowerCase();\n  var imagePath = characterSwitch(character);\n  var imageIndex = getImageIndex();\n\n  var imageSrc = 'img/' + imagePath + '-' + imageIndex + '.jpg';\n  _base.elements.quoteImage.setAttribute('src', imageSrc);\n  _base.elements.quoteImage.style.visibility = 'visible';\n};\n\nvar getImageIndex = function getImageIndex() {\n  var index = Math.ceil(Math.random() * 5);\n  return index;\n};\n\nvar characterSwitch = function characterSwitch(char) {\n  switch (char) {\n    case 'jerry':\n      return 'jerry/jerry';\n      break;\n    case 'george':\n      return 'george/george';\n      break;\n    case 'elaine':\n      return 'elaine/elaine';\n      break;\n    case 'kramer':\n      return 'kramer/kramer';\n      break;\n    default:\n      return 'generic/generic';\n  }\n};\n\nvar filterQuotes = exports.filterQuotes = function filterQuotes(array, character) {\n\n  var filteredArray = array.filter(function (el) {\n    return el.author.toLowerCase() === character;\n  });\n  return filteredArray;\n};\n\n//# sourceURL=webpack:///./src/js/views/quotesView.js?");

/***/ }),

/***/ "./src/js/views/synopsisView.js":
/*!**************************************!*\
  !*** ./src/js/views/synopsisView.js ***!
  \**************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.clearSynopsis = exports.renderSynopsis = exports.renderEpisodeName = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar renderEpisodeName = exports.renderEpisodeName = function renderEpisodeName(season, episode, episodesArray) {\n  var thisEpisode = episodesArray.filter(function (el) {\n    return parseInt(el.season) === parseInt(season) && parseInt(el.number) === parseInt(episode);\n  });\n\n  var html = '\\n  <p>\"' + thisEpisode[0].name + '\"\\n  ';\n\n  _base.elements.quoteText.insertAdjacentHTML('beforeend', html);\n};\n\nvar renderSynopsis = exports.renderSynopsis = function renderSynopsis(season, episode, episodesArray) {\n  var thisEpisode = episodesArray.filter(function (el) {\n    return parseInt(el.season) === parseInt(season) && parseInt(el.number) === parseInt(episode);\n  });\n\n  var html = '\\n    <h3>Episode Synopsis</h3>\\n    <p id=\"synopsis\">' + thisEpisode[0].summary + '</p>\\n  ';\n\n  _base.elements.synopsis.insertAdjacentHTML('beforeend', html);\n};\n\nvar clearSynopsis = exports.clearSynopsis = function clearSynopsis() {\n  _base.elements.synopsis.innerHTML = '';\n};\n\n//# sourceURL=webpack:///./src/js/views/synopsisView.js?");
